...
public class DLDHDTList<E> extends AbstractDLList<E> {
	...
	public Node<E> getNodeAfter(Node<E> target)
		...
		if(((DNode<E>) target).getNext().equals(trailer)) throw new NoSuchElementException("getNodeAfter(): target is the last element");
		return ((DNode<E>) target).getNext();
	}

	public Node<E> getNodeBefore(Node<E> target)
			throws NoSuchElementException {
		if(((DNode<E>) target).getPrev().equals(header)) throw new NoSuchElementException("getNodeBefore(): target is the first element");
	...
	public E[] toArray(){
		E[] array = (E[]) new Object[this.length()];
